...
import com.example.fourpicturesonewords.adapter.EpisodeAdapter
import com.example.fourpicturesonewords.contract.GameFragmentContract
import com.example.fourpicturesonewords.databinding.DeleteDialogBinding
import com.example.fourpicturesonewords.databinding.EpisodeDialogBinding
import com.example.fourpicturesonewords.databinding.FragmentGameBinding
import com.example.fourpicturesonewords.databinding.ResultDialogBinding
import com.example.fourpicturesonewords.databinding.WarningDialogBinding
import com.example.fourpicturesonewords.databinding.WinDialogBinding
import com.example.fourpicturesonewords.impl.game.ModelImpl
import com.example.fourpicturesonewords.impl.game.PresenterImpl
...
class GameFragment : Fragment(), GameFragmentContract.View {
    ...
    override fun episodeDialog() {
        ...
        val dialogBinding: EpisodeDialogBinding = EpisodeDialogBinding.inflate(
            LayoutInflater.from(requireContext()), binding.root, false
        )
